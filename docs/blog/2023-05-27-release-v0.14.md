...
- Modify default ColumnOption from NOT NULL to NULL [@devgony](https://github.com/devgony) (#997)
...
- Add enum `StrSlice` under enum `Evaluated` [@zmrdltl](https://github.com/zmrdltl) (#999)
...
- Implement ValidationContext(schema\_map + alias) to enhance validation of ambiguous columns [@devgony](https://github.com/devgony) (#883)
...
- Apply binary\_op macros to existing data types [@ChobobDev](https://github.com/ChobobDev) (#987)
...
- Improve duplicate column names validation [@devgony](https://github.com/devgony) (#995)
- Register `lock` when `fetch_all_schemas` face `idle` [@devgony](https://github.com/devgony) (#996)
- Merge ColumnOption::{Null, NotNull} into a single option [@devgony](https://github.com/devgony) (#986)
- Update rust.yml github action to test examples/ [@panarch](https://github.com/panarch) (#994)
