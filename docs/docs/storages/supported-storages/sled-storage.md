...
SledStorage can only be used in a Rust environment. It supports non-clustered indexes and transactions. If you're looking for a basic storage to handle and store data in a Rust environment, SledStorage is an excellent choice.
