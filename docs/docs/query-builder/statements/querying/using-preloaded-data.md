...
This guide will show you how to use Query Builder to query data that has already been loaded into memory, as opposed to querying data from storage. This is similar to SQL's `VALUES` functionality. 
...
```rust
use gluesql_core::query_builder::values;
