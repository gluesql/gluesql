...
This document covers the `alias_as` functionality of the Query Builder in the GlueSQL project. The `alias_as` method allows you to create a derived subquery, which is similar to subqueries in SQL. It gives you the ability to use the output of a query as a table to perform further queries.
