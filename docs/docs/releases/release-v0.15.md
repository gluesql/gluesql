...
- Implement entries in query builder [@2-NOW](https://github.com/2-NOW) ([#1364](https://github.com/gluesql/gluesql/pull/1364))
- Implement GREATEST function [@TheMan1697](https://github.com/TheMan1697) ([#1312](https://github.com/gluesql/gluesql/pull/1312))
- Implement bitwise-not operator (~) in query builder [@gurugio](https://github.com/gurugio) ([#1366](https://github.com/gluesql/gluesql/pull/1366))
...
- Add ExprWithAliasNode to query builder [@julia-ing](https://github.com/julia-ing) ([#1359](https://github.com/gluesql/gluesql/pull/1359))
...
- Implement `query_builder` for skip function [@cl-kim](https://github.com/cl-kim) ([#1334](https://github.com/gluesql/gluesql/pull/1334))
...
- feat: implement `query_builder` for replace function [@ChobobDev](https://github.com/ChobobDev) ([#1275](https://github.com/gluesql/gluesql/pull/1275))
...
- \[Query Builder] Implement ascii, chr function in ast [@seonghun-dev](https://github.com/seonghun-dev) ([#1244](https://github.com/gluesql/gluesql/pull/1244))
- \[Query Builder] Implement Geometic Point Type and Geometric Function in Query Builder [@seonghun-dev](https://github.com/seonghun-dev) ([#1222](https://github.com/gluesql/gluesql/pull/1222))
...
- Update docs/query-builder padding.md code block lang keyword, [@panarch](https://github.com/panarch) ([#1436](https://github.com/gluesql/gluesql/pull/1436))
...
- test: write example for query builder [@daengdaengLee](https://github.com/daengdaengLee) ([#1259](https://github.com/gluesql/gluesql/pull/1259))
...
- chore: remove `Result` from `query_builder::transaction` return type [@ever0de](https://github.com/ever0de) ([#1404](https://github.com/gluesql/gluesql/pull/1404))
...
- Add test and doc for query-builder::statements::querying::data-aggregation [@devgony](https://github.com/devgony) ([#1224](https://github.com/gluesql/gluesql/pull/1224))
