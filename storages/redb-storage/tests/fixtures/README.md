...
`v2/mixed_schema_schemaless.redb` was generated by running the ignored test
`generate_v2_mixed_schema_schemaless_fixture` from commit `2545eccb` using raw `redb` + `bincode`
(no GlueSQL storage API) as documented in the sidecar.
