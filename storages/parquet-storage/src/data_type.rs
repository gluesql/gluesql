...
impl ParquetBasicPhysicalType {
    ...
    pub fn convert_to_data_type(pt: &Type) -> Result<DataType, Error> {
        match pt {
            ...
            //     ParquetStorageError::UnmappedParquetType(*pt).to_string(),
            // )),
        }
    }
}
...
//     pub fn convert_to_data_type(ct: &ConvertedType) -> Result<DataType, Error> {
//         match ct {
//             ConvertedType::UTF8 | ConvertedType::JSON => Ok(DataType::Text),
...
//             _ => Err(Error::StorageMsg(
//                 ParquetStorageError::UnmappedParquetConvertedType(*ct).to_string(),
//             )),
//         }
//     }
// }
