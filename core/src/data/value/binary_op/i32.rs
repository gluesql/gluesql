...
impl PartialOrd<Value> for i32 {
    fn partial_cmp(&self, other: &Value) -> Option<Ordering> {
        match other {
            ...
            U16(other) => PartialOrd::partial_cmp(self, &(*other as i32)),
