...
impl TryBinaryOperator for Decimal {
    ...
    fn try_add(&self, rhs: &Self::Rhs) -> Result<Value> {
        ...
        match *rhs {
            ...
            I32(rhs) => match lhs.checked_add(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: I32(rhs),
            ...
            U8(rhs) => match lhs.checked_add(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: U8(rhs),
            ...
            U32(rhs) => match lhs.checked_add(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: U32(rhs),
            ...
            U64(rhs) => match lhs.checked_add(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: U64(rhs),
            ...
            U128(rhs) => match lhs.checked_add(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: U128(rhs),
    ...
    fn try_subtract(&self, rhs: &Self::Rhs) -> Result<Value> {
        ...
        match *rhs {
            ...
            I32(rhs) => match lhs.checked_sub(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: I32(rhs),
            ...
            U8(rhs) => match lhs.checked_sub(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: U8(rhs),
            ...
            U32(rhs) => match lhs.checked_sub(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: U32(rhs),
            ...
            U64(rhs) => match lhs.checked_sub(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: U64(rhs),
            ...
            U128(rhs) => match lhs.checked_sub(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: U128(rhs),
    ...
    fn try_multiply(&self, rhs: &Self::Rhs) -> Result<Value> {
        ...
        match *rhs {
            ...
            I32(rhs) => match lhs.checked_mul(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: I32(rhs),
            ...
            U8(rhs) => match lhs.checked_mul(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: U8(rhs),
            ...
            U32(rhs) => match lhs.checked_mul(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: U32(rhs),
            ...
            U64(rhs) => match lhs.checked_mul(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: U64(rhs),
            ...
            U128(rhs) => match lhs.checked_mul(Decimal::from(rhs)) {
                Some(x) => Ok(Decimal(x)),
                None => Err(ValueError::BinaryOperationOverflow {
                    lhs: Decimal(lhs),
                    rhs: U128(rhs),
