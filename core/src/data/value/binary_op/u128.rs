...
mod tests {
    ...
    fn test_extremes() {
        ...
        //try_subtract  (converts to an i128 since we have a signed integer in subtraction)
        ...
        //these should fail since it is unsigned and we are doing a 0 - 1
        assert_eq!(
    ...
    fn try_add() {
        ...
        assert_eq!(base.try_add(&U8(1)), Ok(U128(2)));
        assert_eq!(base.try_add(&U32(1)), Ok(U128(2)));
        assert_eq!(base.try_add(&U64(1)), Ok(U128(2)));
    ...
    fn try_subtract() {
        ...
        assert_eq!(base.try_subtract(&U8(1)), Ok(U128(0)));
        assert_eq!(base.try_subtract(&U32(1)), Ok(U128(0)));
        assert_eq!(base.try_subtract(&U64(1)), Ok(U128(0)));
    ...
    fn try_multiply() {
        ...
        assert_eq!(base.try_multiply(&U8(2)), Ok(U128(6)));
        assert_eq!(base.try_multiply(&U32(2)), Ok(U128(6)));
        assert_eq!(base.try_multiply(&U64(2)), Ok(U128(6)));
        ...
        assert_eq!(base.try_multiply(&U8(1)), Ok(U128(3)));
        assert_eq!(base.try_multiply(&U32(1)), Ok(U128(3)));
        assert_eq!(base.try_multiply(&U64(1)), Ok(U128(3)));
    ...
    fn try_divide() {
        ...
        assert_eq!(base.try_divide(&U8(2)), Ok(U128(3)));
        assert_eq!(base.try_divide(&U32(2)), Ok(U128(3)));
        assert_eq!(base.try_divide(&U64(2)), Ok(U128(3)));
        ...
        assert_eq!(base.try_divide(&U8(6)), Ok(U128(1)));
        assert_eq!(base.try_divide(&U32(6)), Ok(U128(1)));
        assert_eq!(base.try_divide(&U64(6)), Ok(U128(1)));
    ...
    fn try_modulo() {
        ...
        assert_eq!(base.try_modulo(&U8(1)), Ok(U128(0)));
        assert_eq!(base.try_modulo(&U32(1)), Ok(U128(0)));
        assert_eq!(base.try_modulo(&U64(1)), Ok(U128(0)));
        ...
        assert_eq!(base.try_modulo(&U8(2)), Ok(U128(1)));
        assert_eq!(base.try_modulo(&U32(2)), Ok(U128(1)));
        assert_eq!(base.try_modulo(&U64(2)), Ok(U128(1)));
