    ...
    F: FnMut(&mut Expr),
{
    match func {
        ...
        | Function::Dedup(expr)
        | Function::GetX(expr)
        | Function::GetY(expr) => visit_mut_expr(expr, f),
        ...
        Function::Replace { expr, old, new } => {
            visit_mut_expr(expr, f);
            visit_mut_expr(old, f);
            visit_mut_expr(new, f);
        }
        ...
        Function::NullIf { expr1, expr2 } => {
            visit_mut_expr(expr1, f);
            visit_mut_expr(expr2, f);
        }
        ...
        Function::Log { antilog, base } => {
            visit_mut_expr(antilog, f);
            visit_mut_expr(base, f);
        }

        Function::Div { dividend, divisor } | Function::Mod { dividend, divisor } => {
            visit_mut_expr(dividend, f);
            visit_mut_expr(divisor, f);
        }
        ...
        Function::Position {
            ...
            visit_mut_expr(from_expr, f);
            visit_mut_expr(sub_expr, f);
        }
        ...
        Function::CalcDistance {
            ...
            visit_mut_expr(geometry1, f);
            visit_mut_expr(geometry2, f);
        }
        ...
        Function::Splice {
            ...
            visit_mut_expr(list_data, f);
            visit_mut_expr(begin_index, f);
            visit_mut_expr(end_index, f);
