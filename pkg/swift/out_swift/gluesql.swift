...
open func getId() -> String  {
    ...
    uniffi_gluesql_fn_method_glue_get_id(self.uniffiClonePointer(),$0
    )
})
}
    
open func getKind() -> GlueStorageKind  {
    return try!  FfiConverterTypeGlueStorageKind_lift(try! rustCall() {
    uniffi_gluesql_fn_method_glue_get_kind(self.uniffiClonePointer(),$0
    )
})
}
...
public struct FfiConverterTypeValue: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Value {
        ...
        case 6: return .i128(try FfiConverterTypeI128.read(from: &buf)
        )
        ...
        case 11: return .u128(try FfiConverterTypeU128.read(from: &buf)
        )
    ...
    public static func write(_ value: Value, into buf: inout [UInt8]) {
        ...
        case let .i128(v1):
            writeInt(&buf, Int32(6))
            FfiConverterTypeI128.write(v1, into: &buf)
        ...
        case let .u128(v1):
            writeInt(&buf, Int32(11))
            FfiConverterTypeU128.write(v1, into: &buf)
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_gluesql_checksum_method_glue_get_id() != 14674) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_gluesql_checksum_method_glue_get_kind() != 55441) {
        return InitializationResult.apiChecksumMismatch
    }
