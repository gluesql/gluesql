...
/**
 * Test class to validate SqlValue data type conversions and verify how each data case is handled
 * when converted from Rust to Java.
 */
public class SqlValueTest {
  ...
  void testBytesValue() {
    byte[] testBytes = {
      (byte) 0x00, (byte) 0x01, (byte) 0x02, (byte) 0xFF, (byte) 0xAB, (byte) 0xCD
    };
